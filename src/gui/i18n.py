...
TRANSLATIONS: dict[str, dict[str, Any]] = {
    "en": {
        ...
        "settings_model_tip": "Example: xlm-roberta-base-ViT-B-32",
        "settings_pretrained_tip": "Example: laion5b_s13b_b90k",
        "ok": "OK",
        "cancel": "Cancel",
    },
    "zh": {
        ...
        "pretrained": "预训练权重",
        "apply_note": "保存后立即生效。",
        "settings_model_tip": "例如：xlm-roberta-base-ViT-B-32",
        "settings_pretrained_tip": "例如：laion5b_s13b_b90k",
        "ok": "确定",
        "cancel": "取消",
    },
}
